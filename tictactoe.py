...
def checkWinner():
    if (button1['text'] == 'O' and button2['text'] == 'O' and button3['text'] == 'O' or
       ...
       button3['text'] == 'O' and button5['text'] == 'O' and button7['text'] == 'O' ):
        messagebox._show("Winner Winner Chicken Dinner", "Player O is winner")
    ...
    if (button1['text'] == 'X' and button2['text'] == 'X' and button3['text'] == 'X' or
       ...
       button3['text'] == 'X' and button5['text'] == 'X' and button7['text'] == 'X' ):
        messagebox._show("Winner Winner Chicken Dinner", "Player X is winner")

root = Tk()
root.geometry('560x375')                #geometry is used to define the size of application
